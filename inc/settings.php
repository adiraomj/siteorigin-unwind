...
function siteorigin_unwind_menu_breakpoint_css( $css, $settings ) {
	$breakpoint = isset( $settings[ 'theme_settings_navigation_menu_breakpoint' ] ) ? $settings[ 'theme_settings_navigation_menu_breakpoint' ] : 768;
...
function siteorigin_unwind_settings_defaults( $defaults ) {
	...
	// Navigation defaults.
	$defaults['navigation_menu_breakpoint'] = '768';
